      ...
      <div class="card-vola">
        <div class="card-body p-4">
          <div class="text-center mb-4">
            <div class="stat-icon red mx-auto mb-2" style="width:56px;height:56px;font-size:1.5rem;">
              <i class="bi bi-arrow-down-left-circle"></i>
            </div>
            <h5 class="fw-bold">Effectuer un retrait</h5>
          </div>
          ...
          <form action="/operations/store" method="post">
            ...
            <label for="montant" class="form-label fw-semibold">Montant du retrait (Ar)</label>
            ...
            <button type="submit" class="btn btn-vola btn-vola-red w-100 btn-lg mb-2">
              <i class="bi bi-arrow-down-left-circle me-1"></i>Effectuer le retrait
            </button>
